...
public class MainApplicationClass extends Application {
    ...
    //TODO: this needs to be updated
        ...
        labelTextFieldController.setText("Label for Text Field:");
        ...
        FXMLLoader labelComboBoxLoader = new FXMLLoader(getClass().getResource("/com/board/config/boardconfiggui/dropdown_widget.fxml"));
        ...
        labelComboBoxController.setItems(FXCollections.observableArrayList("Option 1", "Option 2", "Option 3"));
